...
a = Analysis(
    ...
    excludes=[
        ...
        'filecmp',
        'statvfs',
        # Additional Avast-specific exclusions to prevent WIN64:MALWARE-GEN
        'socket',
        'ssl',
        'http',
        'http.client',
        ...
        'binhex',
        'quopri',
        # Exclude system introspection modules
        'inspect',
        'dis',
        'ast',
        'parser',
        ...
        'tokenize',
        'keyword',
        # Exclude dynamic loading modules that trigger AV
        'imp',
        'pkgutil',
        'runpy',
        'modulefinder',
        # Exclude Windows-specific modules that cause false positives
        'msilib',
        'winreg',
        'winsound',
        # Exclude compression modules that trigger packers detection
        'gzip',
        'bz2',
        'lzma',
        'tarfile',
        'zipimport',
        # Exclude XML processing (potential XXE triggers)
        'xml',
        'xml.etree',
        'xml.dom',
        'xml.sax',
        'xml.parsers',
        # Exclude execution-related modules
        'subprocess32',
        'popen2',
        'commands',
        'pipes',
...
# Create distribution
# On macOS, skip symlink creation to avoid conflicts
if sys.platform == "darwin":
    import os
    # Clean any existing symlinks before COLLECT
    if os.path.exists("dist/Docx2Shelf/_internal/Python"):
        try:
            os.unlink("dist/Docx2Shelf/_internal/Python")
        except:
            pass
