...
a = Analysis(
    ...
    runtime_hooks=[],
    excludes=[
        # Exclude heavy data science libraries not needed for document conversion
        'matplotlib',
        'numpy',
        'pandas',
        'scipy',
        ...
        'py_compile',
        'compileall',
        # Exclude unnecessary network protocols
        'xmlrpc',
        'ftplib',
        'telnetlib',
        'smtplib',
        ...
        'watchdog',
        'inotify',
        # Exclude advanced system modules not needed
        'fcntl',
        'termios',
        'syslog',
        'grp',
        'pwd',
        'spwd',
        # Exclude process/system monitoring not needed
        'psutil',
    ],
