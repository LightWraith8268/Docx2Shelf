...
class JSONLogger:
    ...
    def log_build_start(self, input_file: Path, output_file: Path, metadata: Any, options: Any) -> None:
    ...
    def log_conversion_phase(self, phase: str, details: Optional[Dict] = None) -> None:
        ...
        self.log_event('conversion_phase', {
            'phase': phase,
            'details': details or {}
        })

    def log_warning(self, message: str, category: str = 'general', details: Optional[Dict] = None) -> None:
    ...
    def log_error(self, message: str, category: str = 'general', details: Optional[Dict] = None) -> None:
    ...
    def _serialize_metadata(self, metadata) -> Dict[str, Any]:
        ...
        result = {}
        for attr in ['title', 'author', 'language', 'publisher', 'description', 'isbn', 'series', 'series_index']:
            value = getattr(metadata, attr, None)
            if value is not None:
                result[attr] = str(value) if not isinstance(value, (str, int, float, bool)) else value
    ...
    def _serialize_options(self, options) -> Dict[str, Any]:
        ...
        result = {}
        for attr in ['theme', 'split_at', 'epub_version', 'image_format', 'hyphenate', 'justify', 'toc_depth']:
