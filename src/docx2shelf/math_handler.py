...
class MathProcessor:
        ...
        for math_elem in mathml_elements:
            try:
                ...
                if primary_format == MathFormat.MATHML:
                    ...
                    self._replace_math_element(soup, math_elem, primary_content, primary_format, alt_text)
                ...
                equation = EquationInfo(
                    ...
                    primary_content=mathml_content if primary_format == MathFormat.MATHML else primary_content,
    ...
    def _get_equation_alt_text(self, content: str, interactive: bool, existing_alt: str = "") -> str:
    ...
    def _latex_to_svg(self, latex: str) -> str:
        ...
        try:
            ...
            try:
                ...
                text = ax.text(0.5, 0.5, latex, transform=ax.transAxes,
                              ha='center', va='center', fontsize=self.config.svg_font_size)
    ...
    def _create_fallback(self, mathml_content: str, fallback_format: MathFormat) -> Tuple[str, MathFormat]:
    ...
    def _replace_math_element(self, soup, old_elem, new_content: str, format_type: MathFormat, alt_text: str) -> None:
