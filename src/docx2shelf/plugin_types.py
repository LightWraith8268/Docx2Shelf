...
class PluginClassification:
    ...
    CORE_BUILTIN_PLUGINS: Dict[str, Dict[str, Any]] = {
        "math_handler": {
            "name": "Math Handler",
    ...
    MARKETPLACE_PLUGINS: Dict[str, Dict[str, Any]] = {
        "store_profiles": {
    ...
    def get_plugins_by_category(cls, category: PluginCategory) -> Dict[str, List[str]]:
        ...
        result: Dict[str, List[str]] = {"builtin": [], "marketplace": []}
    ...
    def is_essential_plugin(cls, plugin_id: str) -> bool:
        ...
        if plugin_id not in cls.CORE_BUILTIN_PLUGINS:
            return False
        return bool(cls.CORE_BUILTIN_PLUGINS[plugin_id].get("essential", False))

    @classmethod
    def get_plugin_info(cls, plugin_id: str) -> Dict[str, Any]:
